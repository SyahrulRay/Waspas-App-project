            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model.defer='namecriteria' id="criteria" name="criteria" class="w-full border border-gray-300 p-2 rounded-md focus:outline-none focus:ring focus:ring-blue-400">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" wire:model.defer='weight' id="weight" name="weight" class="w-full border border-gray-300 p-2 rounded-md focus:outline-none focus:ring focus:ring-blue-400">
                        @error('weight') <span class="error">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="category" class="block text-gray-700 font-bold mb-2">Category:</label>
                        <select wire:model.defer='categories' id="category" name="category" class="w-full border border-gray-300 p-2 rounded-md focus:outline-none focus:ring focus:ring-blue-400">
